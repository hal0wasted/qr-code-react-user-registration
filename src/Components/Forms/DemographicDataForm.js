...
class DemographicDataForm extends Component {
  ...
  setDemonstrationType = async () => {
    const { setDemographicSurveyDemonstrationType } = this.props
    // Types: RESEARCH, TRADE_SHOW, STEM_EVENT
    try {
      const response = await axios.get(`${protocol}://${host.getCurrent()}:${port}/getDemonstrationType`)
      const type = response.data
      setDemographicSurveyDemonstrationType(type)
    }catch(err){
      console.log(err)
    }
  }
  ...
  render(){
    const {
      change,
      handleSubmit,
      demographicSurveyDemonstrationType,
    ...
    return (
      ...
      <form onSubmit={ this.props.handleSubmit }>
        ...
        {
          demographicSurveyDemonstrationType === 'RESEARCH'
          ?
          <>
            <br></br>
            <br></br>
        ...
        {
          (demographicSurveyDemonstrationType === 'TRADE_SHOW' ||
          demographicSurveyDemonstrationType === 'RESEARCH')
          ?
          <>
            <br></br>
